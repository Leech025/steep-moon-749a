...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/steep-moon-749a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-moon-749a
```

A live public deployment of this template is available at [https://steep-moon-749a.templates.workers.dev](https://steep-moon-749a.templates.workers.dev)
